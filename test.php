...
<style type="text/css">
    ...
    background-image: url("https://wallpaperplay.com/walls/full/c/7/0/145587.jpg");
...
<p style="font-size: 50px; color: white; text-align: center; font-family:arial;text-shadow:4px 4px 8px purple" ><strong id="heading">Top Influencers</strong></p>


<?php for($x = 1; $x <= $total_pages; $x++): ?>
        <a href='test.php?page=<?php echo $x; ?>'><?php echo $x; ?></a>
                <?php endfor; ?>
        <br><br><br><br><br>
            ...
            <tbody>
                    ...
                    { 
                        ...
                        if(!empty($final[$i]['picture'])) {
                            $e = '<img id="imgg" alt="Image Unavailable" src="'.$final[$i]['picture'].'" />'; }
                        else { $e="";}
